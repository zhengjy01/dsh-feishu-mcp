	...
	factory: (require) => {
		...
		*/
		...
		function statusText(view) {
			...
			return conf + " · MCP " + conn + (view.connected ? "（" + view.toolCount + " 个工具）" : "") + (view.hasUserToken ? " · 含用户令牌" : "") + (view.tokenUpdatedAt ? " · 最近连接 " + view.tokenUpdatedAt : "");
		}
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							"创建企业自建应用，添加所需权限（im/bitable/docx/calendar/drive 等）并发布版本。用户令牌可选， 配置后以用户身份访问私有资源。"
						]
					}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							placeholder: view?.hasUserToken ? "已配置，留空不改" : "可选：user_access_token"
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: s.row,
